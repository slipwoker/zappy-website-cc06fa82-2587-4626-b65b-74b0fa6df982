  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      contactForm.dispatchEvent(new CustomEvent('formValidated', {
        ...
        detail: {
          form: contactForm,
          data: Object.fromEntries(new FormData(contactForm))
        }
      }));
    });
  }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cc06fa82-2587-4626-b65b-74b0fa6df982',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cc06fa82-2587-4626-b65b-74b0fa6df982';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cc06fa82-2587-4626-b65b-74b0fa6df982';
